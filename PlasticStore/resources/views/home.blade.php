...
@section('content')
            ...
            <div class="row gx-2 gy-10 align-items-center">
                <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start order-2 order-lg-0"
                    ...
                    <h1 class="display-1 mb-5 mx-md-10 mx-lg-0">Selamat datang di Plastic Store, tempat Anda menemukan
                        produk biji plastik atau pelet plastik sesuai dengan kebutuhan Anda <br> <span
                    ...
                    <div class="row g-4">
                        <div class="col-4 d-flex flex-column ms-auto" data-cues="fadeIn" data-group="col-start"
                            ...
                            <div class="ms-auto mt-4"><img class="img-fluid rounded shadow-lg"
                                    src="{{ asset('assets/img/bp2.jpg') }}" srcset="{{ asset('assets/img/bp2.jpg') }} 2x"
                                    alt="" /></div>
                            <div><img class="img-fluid rounded shadow-lg mt-4 w-100" src="{{ asset('assets/img/bp5.jpg') }}"
                                    srcset="{{ asset('assets/img/bp5.jpg') }} 2x" alt="" /></div>
                        </div>
                        <!-- /column -->
                        <div class="col-4" data-cues="fadeIn" data-group="col-middle">
                            <div class="ms-auto mt-6"><img class="img-fluid rounded shadow-lg"
                                src="{{ asset('assets/img/bp1.jpg') }}" srcset="{{ asset('assets/img/bp1.jpg') }} 2x"
                                alt="" /></div>
                            <div><img class="img-fluid rounded shadow-lg mt-4" src="{{ asset('assets/img/bp6.jpg') }}"
                                    srcset="{{ asset('assets/img/bp6.jpg') }} 2x" alt="" /></div>
                            <div class="mt-4 mb-10"><img class="img-fluid rounded shadow-lg"
                                    src="{{ asset('assets/img/bp3.jpg') }}" srcset="{{ asset('assets/img/bp3.jpg') }} 2x"
                                    alt="" /></div>
                        </div>
                        <!-- /column -->
                        <div class="col-4 d-flex flex-column" data-cues="fadeIn" data-group="col-end" data-delay="900">
                            <div class="ms-auto mt-4"><img class="img-fluid rounded shadow-lg"
                                    src="{{ asset('assets/img/bp7.jpg') }}" srcset="{{ asset('assets/img/bp7.jpg') }} 2x"
                                    alt="" /></div>
                            <div class="mt-4 mb-10"><img class="img-fluid rounded shadow-lg"
                                    src="{{ asset('assets/img/bp9.jpg') }}" srcset="{{ asset('assets/img/bp9.jpg') }} 2x"
                                    alt="" /></div>
                        </div>
                        <!-- /column -->
                    </div>
    ...
    <section class="wrapper bg-soft-primary">
        <div class="container pt-5 pb-15 py-lg-17 py-xl-19 pb-xl-20 position-relative">
            <img class="position-lg-absolute  rounded" src="{{ asset('assets/img/kategori.jpg') }}"
                srcset="{{ asset('assets/img/kategori.jpg') }} 2x" data-cue="fadeIn" alt="" />
            <div class="row gx-0 align-items-center">
                <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-10 offset-xxl-7 ps-xxl-12 mt-md-n9 text-center text-lg-start"
                    ...
                    <p class="lead fs-lg mb-7 px-md-10 px-lg-0">Menyediakan berbagai macam kategori biji plastik atau pelet
                        plastik yang Anda butuhkan, seperti PE - Polyethylene ,PP - Polypropylene ,PS - Polystyrene, dan
                        sebagainya. </p>
        ...
        <div class="container pt-8 pt-md-14">
            <div class="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-10 mb-lg-16 align-items-center">
                <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-1 position-relative order-lg-2" data-cue="zoomIn">
                    ...
                    <figure class="rounded"><img src="{{ asset('assets/img/brand.jpg') }}"
                            srcset="{{ asset('assets/img/brand.jpg') }} 2x" alt="" /></figure>
                </div>
                <!--/column -->
                <div class="col-lg-5 mt-lg-n10 text-center text-lg-start" data-cues="slideInDown" data-group="page-title"
                    ...
                    <p class="lead fs-25 lh-sm mb-7 px-md-10 px-lg-0">Menyediakan berbagai macam produk biji plastik atau
                        pelet plastik dari berbagai macam brand pilihan, seperti BM, Innoplus, dan sebagainya.</p>
                    <div class="d-flex justify-content-center justify-content-lg-start" data-cues="slideInDown"
                        data-group="page-title-buttons" data-delay="900">
    ...
    <section class="wrapper image-wrapper bg-image bg-overlay text-white"
        data-image-src="{{ asset('/assets/img/proses.jpg') }}">
        <section class="wrapper bg-gradient-primary">
            <div class="container py-14 pt-md-15 pb-md-18">
                <div class="row text-center">
                    <div class="col-lg-9 col-xxl-7 mx-auto" data-cues="zoomIn" data-group="welcome"
                        ...
                        <p class="lead fs-24 lh-sm px-md-5 px-xl-15 px-xxl-10 mb-7 ">Menyediakan berbagai macam produk biji
                            plastik atau pelet plastik berdasarkan jenis pengolahannya, seperti Lamination, Blow, Injection,
                            dan sebagainya.</p>
                    </div>
                    <!-- /column -->
                </div>
