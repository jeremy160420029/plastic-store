            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-success">Address is set to: {{ auth()->user()->street_address }}, {{ auth()->user()->city }}, {{ auth()->user()->postal_code }}</p>
                        @else
                        ...
                        <form method="POST" action="{{ route('profile.updateAddress') }}">
                            ...
                            <div class="form-group my-2">
                                ...
                                <input id="street_address" type="text" class="form-control @error('street_address') is-invalid @enderror" name="street_address" value="{{ old('street_address', auth()->user()->street_address) }}" required autofocus>
                            ...
                            <div class="form-group my-2">
                                ...
                                <select id="city" class="form-control @error('city') is-invalid @enderror" name="city" required>
                                    ...
                                    <option value="Denpasar" {{ old('city', auth()->user()->city) === 'Denpasar' ? 'selected' : '' }}>Denpasar</option>
                                    <option value="Medan" {{ old('city', auth()->user()->city) === 'Medan' ? 'selected' : '' }}>Medan</option>
                                    <option value="Palembang" {{ old('city', auth()->user()->city) === 'Palembang' ? 'selected' : '' }}>Palembang</option>
                                    <option value="Batam" {{ old('city', auth()->user()->city) === 'Batam' ? 'selected' : '' }}>Batam</option>
                                    <option value="Semarang" {{ old('city', auth()->user()->city) === 'Semarang' ? 'selected' : '' }}>Semarang</option>
